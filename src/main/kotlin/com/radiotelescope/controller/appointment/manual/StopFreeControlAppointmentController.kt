...
/**
 * REST Controller to handle ending a Free Control Appointment
 *
 * @param wrapper the [UserManualAppointmentWrapper]
 * @param logger the [Logger] service
 */
@RestController
class StopFreeControlAppointmentController(
     ...
     * [UserManualAppointmentWrapper.stopAppointment] method.
     *
     ...
     *
     * Otherwise, the [StopFreeControlAppointment] command was executed, and the
     * controller will respond based on if this command was a success or not.
     */
    @PutMapping(value = ["/api/appointments/{appointmentId}/stop"])
    fun execute(@PathVariable(value = "appointmentId") id: Long): Result {
        wrapper.stopAppointment(id) { response ->
            ...
            response.success?.let { data ->
                ...
                logger.createSuccessLog(
                        info = Logger.createInfo(
                                ...
                                action = "End Free Control Appointment",
