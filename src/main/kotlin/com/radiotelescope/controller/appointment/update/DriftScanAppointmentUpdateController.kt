 ...
 */
@RestController
class DriftScanAppointmentUpdateController(
        @Qualifier(value = "driftScanAppointmentWrapper")
        private val autoAppointmentWrapper: UserAutoAppointmentWrapper,
        logger: Logger
): BaseRestController(logger) {
    /**
     * Execute method that is in charge of adapting the [DriftScanAppointmentUpdateForm]
     * into a [DriftScanAppointmentUpdate.Request] after ensuring no fields are null. If
