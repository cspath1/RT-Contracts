...
internal class DriftScanAppointmentRequestFormTest {
    val baseForm = DriftScanAppointmentRequestForm(
            userId = 1L,
    ...
    fun testToRequest() {
        ...
        assertEquals(theRequest.elevation, baseForm.elevation!!, 0.0)
        assertEquals(theRequest.azimuth, baseForm.azimuth!!, 0.0)
    }
